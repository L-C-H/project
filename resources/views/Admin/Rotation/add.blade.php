...
<div class="page-container">
	<form class="form form-horizontal" id="form-article-add" method="post" action="/adminrotation" enctype="multipart/form-data">
		<div class="row cl">
			<label class="form-label col-xs-4 col-sm-2"><span class="c-red">*</span>轮播图名称</label>
			<div class="formControls col-xs-8 col-sm-9">
				<input type="text" class="input-text" value="{{old('picname')}}" placeholder="" id="" name="picname">
			</div>
		</div>
		<div class="row cl">
			<label class="form-label col-xs-4 col-sm-2"><span class="c-red">*</span>状态</label>
			<div class="formControls col-xs-8 col-sm-9">
				<input type="text" class="input-text" value="{{old('status')}}" placeholder="" id="" name="status">
			</div>
		</div>
		<div class="row cl">
			...
			<div class="formControls col-xs-8 col-sm-9">
				...
				<textarea name="description" id="" cols="60" rows="10">{{old('description')}}</textarea>
			</div>
		</div>
        <div class="row cl">
