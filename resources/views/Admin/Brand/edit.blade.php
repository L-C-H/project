	...
	<form class="form form-horizontal" id="form-article-add" action="/adminbrand/{{$res->id}}" method="post" enctype="multipart/form-data">
		...
		<div class="row cl">
            ...
            <span class="btn-upload form-group">
  				<input class="input-text upload-url radius" type="text" name="b_pic" id="uploadfile-1" readonly value="{{$res->b_pic}}"><a href="javascript:void();" class="btn btn-primary radius"><i class="iconfont">&#xf0020;</i> 选择文件</a>
